...
{
    public static TextAlignment GetTextAlignment(AlignmentComboBoxEnum alignmentComboBoxEnum) => (TextAlignment)((int)alignmentComboBoxEnum & 0x0F);
    public static ParagraphAlignment GetParagraphAlignment(AlignmentComboBoxEnum alignmentComboBoxEnum) => (ParagraphAlignment)((int)alignmentComboBoxEnum >> 4);
}
